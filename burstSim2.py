...
nDex = 50 # (ms^-1) donor excitation rate by green laser
nAex = 50 # (ms^-1) acceptor excitation rate by red laser
epsG = 0.9 # detection efficiency of green signal
...
fA0 = 0.4 # acceptor only fraction
...
# multiple molecule
meanN = 1 # average number of multiple molecules meanN >= 1 (poisson distributed)
boolSame = 0 # boolean: 0 -> independent multiple molecules; 1 -> multiple molecules in the same complex

numIter = 50000 # number of molecules per FRET efficiency value
#########################################################################################################################
